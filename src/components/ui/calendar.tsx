  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          'flex min-h-(--cell-size) w-full items-center justify-center px-(--cell-size) py-1',
        ...
        dropdown_root: cn(
          'relative rounded-(--cell-radius) border border-(--color-border) bg-bg-offset px-2 py-0.5 text-(--color-fg)',
          defaultClassNames.dropdown_root,
        ),
        dropdown: cn('absolute inset-0 bg-bg-offset opacity-0', defaultClassNames.dropdown),
        caption_label: cn(
        ...
        outside: cn(
          'text-(--color-fg-light) aria-selected:text-(--color-fg-light)',
          defaultClassNames.outside,
        ),
        disabled: cn('text-(--color-fg-light) opacity-50', defaultClassNames.disabled),
